  ...
  return (
    <div className="min-w-[300px] w-2/6" data-section="ready-to-build">
      ...
      <ExpandButton
        variant="white"
        href={`/${locale}/wizard`}
        className={`group flex items-center mb-6 cursor-pointer bg-[oklch(1_0_0)] text-[oklch(0.145_0_0)] border-[oklch(1_0_0)] ${isRTL ? 'flex-row-reverse justify-center md:justify-start' : ''}`}>
