  ...
  return (
    <div className="flex items-center gap-0.5 md:gap-1">
      ...
      <Button
        ...
        className="md:hidden h-12 w-12 p-2 rounded-full bg-transparent hover:bg-accent/50 transition-colors"
        size="icon"
        variant="ghost"
        type="button"
      >
      ...
      {isAuthenticated ? (
        ...
        <>
          ...
          <Link
            href={`/${locale}/login`}
            className="md:hidden h-12 w-12 p-2 flex items-center justify-center rounded-full hover:bg-accent"
          >
