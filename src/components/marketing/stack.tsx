      ...
      <div className="mx-auto flex max-w-full flex-col items-center space-y-4 text-center">
        ...
        <p className="max-w-[95%] md:max-w-[65%] leading-normal text-muted-foreground sm:text-lg sm:leading-7 pb-7">
          <span className="block sm:hidden">
            Databayt leverages state-of-the-art technology to craft innovative
            applications.
          </span>
          <span className="hidden sm:block">
            Databayt leverages state-of-the-art technology to craft innovative
            and modern applications, delivering seamless performance.
          </span>
        </p>
      </div>
        ...
        <div className="relative overflow-hidden rounded-2xl  bg-muted p-2">
          <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Server and Client Components. <br /> Use hook.
              </p>
            </div>
          </div>
        </div>
