  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row">
        {/* Video/Image Section - First on mobile, right on desktop */}
        <div className="order-1 lg:order-2 lg:w-[60%] bg-gray-900 dark:bg-black overflow-hidden">
        ...
        <div className="order-2 lg:order-1 lg:w-[40%] p-8">
...
{locale === 'ar' && logo === 'آلة الأحلام' ? (
        ...
        {/* Remove duplicate vertical layout - now handled above */}
        {false && (
